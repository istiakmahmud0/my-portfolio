...
const Header = () => {
  ...
  return (
    <header className="z-[999] relative">
      <motion.div
        className="fixed top-0 left-1/2 -translate-x-1/2 h-[4.5rem] w-full rounded-none border border-white opacity-40 
            ...
            >
              ...
              >
                ...
                {link.name === activeSection && (
                  <span className="bg-gray-100 rounded-full inset-0 absolute -z-10"></span>
                )}
              </Link>
            </motion.li>
          ))}
